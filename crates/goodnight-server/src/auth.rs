//! Bearer token authentication middleware 鈥?verifies tokens against the database
    ...
    B: 'static,
{
    ...
    fn call(&self, req: ServiceRequest) -> Self::Future {
        ...
        Box::pin(async move {
            // Verify token 鈥?uses registry if available, falls through to storage backend otherwise
