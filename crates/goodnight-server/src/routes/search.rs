...
use goodnight_core::{SearchMode, SearchOptions, SemanticSearchResult, SimilarAtomResult};
...
#[utoipa::path(
    ...
    responses(
        (status = 200, description = "Grouped global search results", body = goodnight_core::GlobalSearchResponse),
    ),
    tag = "search",
)]
