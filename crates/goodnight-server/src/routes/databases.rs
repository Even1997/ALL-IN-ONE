...
#[utoipa::path(post, path = "/api/databases", request_body = CreateDatabaseBody, responses((status = 201, description = "Database created", body = goodnight_core::DatabaseInfo)), tag = "databases")]
