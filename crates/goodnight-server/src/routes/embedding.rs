...
use goodnight_core::models::PipelineStatus;
use goodnight_core::registry::DatabaseInfo;
use serde::Serialize;
use utoipa::ToSchema;
...
#[utoipa::path(get, path = "/api/embeddings/status", responses((status = 200, description = "Pipeline status summary", body = goodnight_core::PipelineStatus)), tag = "embeddings")]
