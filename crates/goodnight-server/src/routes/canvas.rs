...
#[utoipa::path(get, path = "/api/canvas/atoms-with-embeddings", responses((status = 200, description = "Atoms with embedding vectors", body = Vec<goodnight_core::AtomWithEmbedding>)), tag = "canvas")]
...
#[utoipa::path(post, path = "/api/canvas/level", params(CanvasLevelQuery), request_body(content = Option<CanvasLevelBody>), responses((status = 200, description = "Canvas level data", body = goodnight_core::CanvasLevel)), tag = "canvas")]
...
#[utoipa::path(get, path = "/api/canvas/global", params(GlobalCanvasQuery), responses((status = 200, description = "Global canvas data", body = goodnight_core::GlobalCanvasData)), tag = "canvas")]
