...
#[utoipa::path(
    ...
    responses(
        (status = 200, description = "Most recent briefing with citations", body = goodnight_core::BriefingWithCitations),
...
#[utoipa::path(
    ...
    responses(
        (status = 200, description = "Recent briefings (without citations)", body = Vec<goodnight_core::Briefing>)
    ),
    tag = "briefings"
)]
...
#[utoipa::path(
    ...
    responses(
        (status = 200, description = "Briefing with citations", body = goodnight_core::BriefingWithCitations),
...
#[utoipa::path(
    ...
    responses(
        (status = 200, description = "Briefing generated", body = goodnight_core::BriefingWithCitations),
        (status = 204, description = "No new atoms in the window 鈥?no briefing was generated"),
