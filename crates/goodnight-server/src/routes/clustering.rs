...
#[utoipa::path(post, path = "/api/clustering/compute", request_body = ComputeClustersBody, responses((status = 200, description = "Computed clusters", body = Vec<goodnight_core::AtomCluster>)), tag = "clustering")]
...
#[utoipa::path(get, path = "/api/clustering", responses((status = 200, description = "Saved clusters", body = Vec<goodnight_core::AtomCluster>)), tag = "clustering")]
