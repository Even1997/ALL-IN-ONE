...
#[utoipa::path(get, path = "/api/wiki", responses((status = 200, description = "All wiki articles", body = Vec<goodnight_core::WikiArticleSummary>)), tag = "wiki")]
pub async fn get_all_wiki_articles(db: Db) -> HttpResponse {
    ok_or_error(db.0.get_all_wiki_articles().await)
}

#[utoipa::path(get, path = "/api/wiki/{tag_id}", params(("tag_id" = String, Path, description = "Tag ID")), responses((status = 200, description = "Wiki article with citations", body = goodnight_core::WikiArticleWithCitations), (status = 404, description = "No article for tag", body = ApiErrorResponse)), tag = "wiki")]
pub async fn get_wiki(db: Db, path: web::Path<String>) -> HttpResponse {
    let tag_id = path.into_inner();
    ok_or_error(db.0.get_wiki(&tag_id).await)
}

#[utoipa::path(get, path = "/api/wiki/{tag_id}/status", params(("tag_id" = String, Path, description = "Tag ID")), responses((status = 200, description = "Wiki article status", body = goodnight_core::WikiArticleStatus)), tag = "wiki")]
...
#[utoipa::path(post, path = "/api/wiki/{tag_id}/generate", params(("tag_id" = String, Path, description = "Tag ID")), request_body = GenerateWikiBody, responses((status = 200, description = "Generated wiki article", body = goodnight_core::WikiArticleWithCitations), (status = 400, description = "Error", body = ApiErrorResponse)), tag = "wiki")]
...
#[utoipa::path(post, path = "/api/wiki/{tag_id}/update", params(("tag_id" = String, Path, description = "Tag ID")), request_body = GenerateWikiBody, responses((status = 200, description = "Updated wiki article", body = goodnight_core::WikiArticleWithCitations), (status = 400, description = "Error", body = ApiErrorResponse)), tag = "wiki")]
...
#[utoipa::path(get, path = "/api/wiki/{tag_id}/related", params(("tag_id" = String, Path, description = "Tag ID"), RelatedTagsQuery), responses((status = 200, description = "Related tags", body = Vec<goodnight_core::RelatedTag>)), tag = "wiki")]
...
#[utoipa::path(get, path = "/api/wiki/{tag_id}/links", params(("tag_id" = String, Path, description = "Tag ID")), responses((status = 200, description = "Wiki cross-reference links", body = Vec<goodnight_core::WikiLink>)), tag = "wiki")]
...
#[utoipa::path(get, path = "/api/wiki/suggestions", params(SuggestionsQuery), responses((status = 200, description = "Suggested wiki articles", body = Vec<goodnight_core::SuggestedArticle>)), tag = "wiki")]
...
#[utoipa::path(get, path = "/api/wiki/{tag_id}/versions", params(("tag_id" = String, Path, description = "Tag ID")), responses((status = 200, description = "Version history", body = Vec<goodnight_core::WikiVersionSummary>)), tag = "wiki")]
pub async fn list_wiki_versions(db: Db, path: web::Path<String>) -> HttpResponse {
    let tag_id = path.into_inner();
    ok_or_error(db.0.list_wiki_versions(&tag_id).await)
}

#[utoipa::path(get, path = "/api/wiki/versions/{version_id}", params(("version_id" = String, Path, description = "Version ID")), responses((status = 200, description = "Wiki article version", body = goodnight_core::WikiArticleVersion)), tag = "wiki")]
...
#[utoipa::path(
    ...
    responses(
        (status = 200, description = "Proposal created or no update needed", body = goodnight_core::WikiProposal),
...
#[utoipa::path(
    ...
    params(("tag_id" = String, Path, description = "Tag ID")),
    responses(
        (status = 200, description = "Pending wiki proposal", body = goodnight_core::WikiProposal),
...
#[utoipa::path(
    ...
    params(("tag_id" = String, Path, description = "Tag ID")),
    responses(
        (status = 200, description = "Proposal accepted and promoted to live article", body = goodnight_core::WikiArticleWithCitations),
        (status = 400, description = "Error", body = ApiErrorResponse)
    ),
    tag = "wiki"
)]
