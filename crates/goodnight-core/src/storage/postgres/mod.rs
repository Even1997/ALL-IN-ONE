...
pub struct PostgresStorage {
    ...
    /// Logical database ID 鈥?all queries are scoped to this value.
...
impl PostgresStorage {
    ...
    /// Initialize the schema 鈥?runs migrations on the caller's runtime.
    ...
    async fn run_migrations(&self) -> Result<(), AtomicCoreError> {
        ...
        // Advisory lock key 鈥?arbitrary fixed i64 to serialize migrations
