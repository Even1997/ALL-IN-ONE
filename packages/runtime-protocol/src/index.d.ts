...
export type RuntimeReasoningEventRecord = Extract<RuntimeAssistantTimelineEvent, {
    kind: 'reasoning';
}>;
export type RuntimeApprovalEventRecord = Extract<RuntimeAssistantTimelineEvent, {
    kind: 'approval';
}>;
export type RuntimeQuestionEventRecord = Extract<RuntimeAssistantTimelineEvent, {
    kind: 'question';
}>;
