...
export class ToolExecutor {
    ...
    async execute(call) {
        ...
        try {
            switch (name) {
                ...
                case 'grep':
                    return await this.grep(input);
                case 'ls':
                    return await this.ls(input);
                case 'view':
                ...
                case 'fetch':
                    return await this.fetchUrl(input);
                default:
    ...
    async glob(params) {
        try {
            const result = await invoke('tool_glob', {
                params: {
    ...
    async grep(params) {
        try {
            const result = await invoke('tool_grep', {
                params: {
                    pattern: params.pattern,
                    path: params.path || this.projectRoot,
    ...
    async ls(params) {
        try {
            const result = await invoke('tool_ls', {
                params: {
                    path: params.path || this.projectRoot,
                },
            });
    ...
    async view(params) {
        try {
            const result = await invoke('tool_view', {
                params: {
    ...
    async write(params) {
        try {
            const result = await invoke('tool_write', {
                params: {
                    file_path: params.file_path,
    ...
    async edit(params) {
        try {
            const result = await invoke('tool_edit', {
                params: {
                    file_path: params.file_path,
    ...
    async bash(params) {
        try {
            const result = await invoke('tool_bash', {
                params: {
