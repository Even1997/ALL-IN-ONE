            ...
            <button
              onClick={async () => {
                ...
                try {
                  ...
                  const toolExecutor = new ToolExecutor('/Users/apple/Documents/all-in-one');
                  const normalizedPath = block.filePath.startsWith('/')
                    ? block.filePath
                    : `/Users/apple/Documents/all-in-one/${block.filePath.replace(/^\/+/, '')}`;
