...
const localConfigPath = path.resolve(__dirname, '../../src/modules/ai/claudian/localConfig.ts');

test('claudian config page reads local agent config snapshot and current ai configs', async () => {
