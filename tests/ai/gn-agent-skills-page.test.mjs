...
test('gnAgent skills page exposes a global skill management surface', async () => {
  ...
  assert.match(pageSource, /Skills Library/);
  ...
  assert.match(pageSource, /gn-agent-skills-panel-header/);
  assert.match(pageSource, /gn-agent-skills-list-meta/);
  assert.match(pageSource, /gn-agent-skills-detail-section/);
  assert.match(pageSource, /gn-agent-skills-detail-kv/);
...
test('gnAgent skills page styles follow the current light and dark theme system', async () => {
  ...
  assert.match(cssSource, /\.gn-agent-skills-panel-header\s*\{/);
  assert.match(cssSource, /\.gn-agent-skills-list-meta\s*\{/);
  assert.match(cssSource, /\.gn-agent-skills-detail-kv\s*\{/);
